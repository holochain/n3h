...
class N3hHackMode extends N3hMode {
  ...
  _handleIpcJson (data, senderId) {
    ...
    switch (data.method) {
      ...
      case 'requestState':
        ...
        return
      case 'connect':
        // data.address must be an Advertise
  ...
  async _handleDhtEvent (e) {
    ...
    switch (e.type) {
      ...
      case 'peerHoldRequest':
        // store agent in Data DHT as peer data (this will map agentId to transportId)
        this._dht.post(e)
  ...
  _track (dnaAddress, agentId) {
    ...
    // Notify all known peers of Dna Tracking by Agent
