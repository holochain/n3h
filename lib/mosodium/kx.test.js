...
describe('kx Suite', () => {
  ...
  it('should throw on bad clientsession cliPublic', async () => {
    try {
      await mosodium.kx.clientSession()
    } catch (e) {
      return
    }
    throw new Error('expected exception, got success')
  ...
  it('should throw on bad clientsession srvPublic', async () => {
    try {
      await mosodium.kx.clientSession(Buffer.alloc(0), new sodium.SecBuf(1))
    } catch (e) {
      return
    }
    throw new Error('expected exception, got success')
  ...
  it('should throw on bad clientsession cliSecret', async () => {
    try {
      await mosodium.kx.clientSession(Buffer.alloc(0), 'hi', Buffer.alloc(0))
    } catch (e) {
      return
    }
    throw new Error('expected exception, got success')
  ...
  it('should throw on bad serversession srvPublic', async () => {
    try {
      await mosodium.kx.serverSession()
    } catch (e) {
      return
    }
    throw new Error('expected exception, got success')
  ...
  it('should throw on bad serversession cliPublic', async () => {
    try {
      await mosodium.kx.serverSession(Buffer.alloc(0), await mosodium.SecBuf.insecure(1))
    } catch (e) {
      return
    }
    throw new Error('expected exception, got success')
  ...
  it('should throw on bad serversession srvSecret', async () => {
    try {
      await mosodium.kx.serverSession(Buffer.alloc(0), 'hi', Buffer.alloc(0))
    } catch (e) {
      return
    }
    throw new Error('expected exception, got success')
