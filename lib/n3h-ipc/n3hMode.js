...
class N3hMode extends AsyncClass {
  async init (workDir, rawConfigData) {
    ...
    // override the given port with the only port
    // that will work with Heroku, as given by heroku
    rawConfigData.webproxy.connection.bind = [`wss://0.0.0.0:${process.env.PORT || 0}/`]
