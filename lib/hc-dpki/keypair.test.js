...
describe('KeyBundle Suite', () => {
  ...
  it('should throw on bad signPubId', async () => {
    try {
      await new KeyBundle({
        signPubId: 'HcSCIp5KE88N7OwefwsKhKgAAAAAAAfgikyphqCIpudwrcivgfWuxSju9mecor'
      })
    } catch (e) {
      return
    }
  ...
  it('should throw on bad encPub', async () => {
    try {
      await new KeyBundle({
        signPubId: 'HcSCIp5KE88N7OwefwsKhKgRfJyr465fgikyphqCIpudwrcivgfWuxSju9mecor',
        encPubId: 'HcSCIp5KE88N7OwefwsKhKgRfJyr465fgikyphqCIpudwrcivgfWuxSju9mecor'
      })
    } catch (e) {
      return
    }
  ...
  it('should throw on sign with no signpriv', async () => {
    const p = await new KeyBundle({
      signPubId: 'hkY7aie8zrakLWKjqNAqbw1zZTIVdx3iQ6Y6wEihi1naKVV-I9c0byE-xaI3E7KiSX7vNTVNW1IIisalmTpf2wkeeIdQWQbR'
    })
    try {
