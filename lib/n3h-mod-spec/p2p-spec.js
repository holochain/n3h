...
const P2pEvent = createEventSpec({
  ...
  /**
   */
  peerConnect: (peerAddress, peerTransport) => {
    type.assert.base64String(peerAddress)
    return { peerAddress, peerTransport }
  },
...
class P2p extends AsyncClass {
  ...
  getTransport () {
    ...
    return this._backend.getTransport()
  }
  ...
  getPeer (peerId) {
    ...
    return this._backend.getPeer(peerId)
  }
  ...
  async fetchPeer (peerId) {
    ...
    await this._backend.fetchPeer(peerId)
  }
